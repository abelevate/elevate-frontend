  ...
  return (
    <>
      <div className="text-box">
        ...
        <p><strong>Last updated:</strong> April 05, 2025</p>
        <p>
      ...
      <div className="text-box">
        ...
        <ul>
          ...
          <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our") refers to Elevate.</li>
          ...
          <li><strong>Website</strong> refers to Elevate, accessible from https://getelevate.xyz/</li>
      ...
      <div className="text-box">
        ...
        <ul>
          <li><strong>Necessary / Essential Cookies</strong> – Session Cookies – Administered by Us</li>
          <li><strong>Cookies Policy / Notice Acceptance Cookies</strong> – Persistent Cookies – Administered by Us</li>
          <li><strong>Functionality Cookies</strong> – Persistent Cookies – Administered by Us</li>
        </ul>
      ...
      <div className="text-box">
        ...
        <ul>
          ...
          <li><strong>•	For business transfers: </strong>We may share or transfer Your personal information in connection with, or during negotiations of, any merger, sale of Company assets, financing, or acquisition of all or a portion of Our business to another company.s</li>
      ...
      <ul>
        <li><strong>Business Transactions:</strong> If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</li>
...
<br/>You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they are posted on this page.
      ...
      <ul>
        <li>By visiting this page on our website: https://getelevate.xyz/</li>
      </ul>
